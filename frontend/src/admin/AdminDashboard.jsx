        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-5xl font-black" style={{ background: 'linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>{summary.nearExpiryCount || 0}</p>
              <p className="text-xs mt-2 font-medium" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>
                {summary.nearExpiryCount > 0 ? 'Click to view products' : 'Requires attention'}
              </p>
            </div>
          </div>
        </div>
