...
public class User {
    ...
    public User(Long id, String email, String name, String mobile, UserRole role, String username, String password, String googleId, String whatsappNumber, String telegramChatId, String photoUrl, LocalDateTime createdAt) {
        this.id = id;
        this.email = email;
        this.name = name;
        this.mobile = mobile;
